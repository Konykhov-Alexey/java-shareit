...
class BookingServiceTest {
    ...
    void getBooking_whenUserNotItemOwnerOrBooker_thenAccessDeniedExceptionThrown() {
        ...
        DeniedException accessDeniedException = assertThrows(DeniedException.class,
    ...
    void getUserBookings_whenBookingStateWaiting_shouldReturnWaitingBookings() {
        ...
        assertEquals(2, bookings.size());
        bookings.forEach(bookingDto -> assertEquals(Status.WAITING, bookingDto.getStatus()));
    }
    ...
    void getUserBookings_whenBookingStateRejected_shouldReturnRejectedBookings() {
        ...
        assertEquals(2, bookings.size());
        bookings.forEach(bookingDto -> assertEquals(Status.REJECTED, bookingDto.getStatus()));
    }
