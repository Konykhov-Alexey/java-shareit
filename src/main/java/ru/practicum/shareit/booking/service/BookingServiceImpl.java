...
import ru.practicum.shareit.exception.DeniedException;
...
public class BookingServiceImpl implements BookingService {
    ...
    public List<BookingDto> getUserBookings(long userId, BookingState state) {
        ...
        List<Booking> result = switch (state) {
            ...
            case WAITING -> bookingRepository.findAllByBookerIdAndStatus(userId, Status.WAITING, sort);
            case REJECTED -> bookingRepository.findAllByBookerIdAndStatus(userId, Status.REJECTED, sort);
    ...
    public List<BookingDto> getOwnerBookings(long userId, BookingState state) {
        ...
        List<Booking> result = switch (state) {
            ...
            case WAITING -> bookingRepository.findAllByItemOwnerIdAndStatus(userId, Status.WAITING, sort);
            case REJECTED -> bookingRepository.findAllByItemOwnerIdAndStatus(userId, Status.REJECTED, sort);
